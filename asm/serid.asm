; serid.asm -- PHASE G step 4b. The scratch register round trip.
;
...
;
; OB = 0x55  the card answers: decode, ~RD, ~WR, both U102 directions.
...
SER_SCR:  .equ  0x4807
          ...
          LDAI  0x99          ; poison OB: U35 has no reset, it holds the
